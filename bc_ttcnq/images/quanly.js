...
function Checkfile(file)
{
	...
	if (ext!="")
		if ((ext!="appliction/x-zip-compressed") && (ext!="audio/mid") && (ext!="audio/mpeg")   ){
			alert("File không hợp lệ - Chỉ upload được các kiểu hình .jar - .mid - .mp3 ");
			return false;
		}
...
//**********************************************************************************
function lienhe(hoten,email,noidung,anti)
{
...
//**********************************************************************************
function gopy(tieude,hoten,email,noidung,anti)
{
...
//**********************************************************************************
function thanhvien_insert(user,pass,apass,hoten,email,diachi,dienthoai,anti)
{
	...
	{
		alert("Bạn không thể đăng ký tên đăng nhập này!");
		return false;	
	}
...
//*******************************************************************************
function thanhvien_resetpw(users,email,anti)
{
	...
	{
		alert("Bạn không được quyền lấy lại mật khẩu của tài khoản quản trị");
		return false;
	}
	if (isEmail(email)==false)
   	 {
...
function checkkhtt()
{
	var thongbao=window.confirm("Bạn chắc chắn muốn xóa khách hàng này?");
  if (thongbao==true)
  		return true;
  else 
		return false;
...
{
	var thongbao=window.confirm("Bạn chắc chắn muốn xóa nội dung này?");
  if (thongbao==true)
  		return true;
  else 
		return false;

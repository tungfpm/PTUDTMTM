...
<form method="post" action=index.php?controller=sanpham&task=luusanpham>
  <tr>

    <td colspan="2" class="tieude" align="center">THÊM SẢN PHẨM MỚI</td>
  ...
  <tr>
    ...
    <td><input type="number" name="loaisp" style="width:240px"></td>
  ...
  <tr>
    ...
    <td><input type="text" name="tensp" style="width:240px"></td>
  ...
  <tr>
    ...
    <textarea name="mota" style="width:650px; height:300px;" ></textarea>
  ...
  <tr>
    ...
    <td><input name="file_up" type="text" size="30"></td>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td><input name="gia" type="numbert" maxlength="20" style="width:240px"></td>
    ...
    <td><input name="giakm" type="number" maxlength="20" style="width:240px"></td>
    ...
    <td><input name="baohanh" type="number" maxlength="20" style="width:240px"</td>
  ...
  <tr>
    ...
    <input name="" type="submit" value="Thêm" class="button" onmouseover="style.background='url(../images/button-5.gif)'" onmouseout="style.background='url(../images/button-4.gif)'">

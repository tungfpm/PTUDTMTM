...
<form method="POST" action="index.php?controller=sanpham&task=luunhomsp">
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <input type="text" name="ten" style="width:240px" />
  ...
  <tr>
    ...
    <input name="" type="submit" value="Lưu" class="button" >

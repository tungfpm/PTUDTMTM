...
<table width="560" cellspacing="0" cellpadding="0" bordercolordark="#FFFFFF" style="border:1px solid #CCC;">
          <tr>
            <td height="35" colspan="2" align="center" class="tieude"><div align="center">THÔNG TIN CÁ NHÂN</div></td>
          </tr>
          ...
          <tr onmouseover="style.background='#c8dbf0'" onmouseout="style.background='#FFFFFF'">            
            <td height="35" style="padding-left:70px"><div align="left" style="width:120px">Họ tên KH:</div></td>
          ...
          <tr>
            <td height="35" colspan="2" align="center" bgcolor="#2d94ff">
              ...
              <a href="index.php?controller=thanhvien&task=suathongtin&user=kumizpro">Thay đổi thông tin cá nhân</a>

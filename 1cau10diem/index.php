<?php
 ...
 <p><strong>Product Name: *</strong> 
   ...
   <input type="text" name="quatity" value="<?php echo $quatity; ?>" /><br/>
   <strong>Unit Price: *</strong> 
   <input type="text" name="unitprice" value="<?php echo $unitprice; ?>" /><br/>
   <strong>Expiration Date: *</strong> 
   <input type="text" name="expirationdate" value="<?php echo $expirationdate; ?>" /><br/>
 </p>
...
renderForm($productname, $quatity, $unitprice, $expirationdate, $error);
 ...
 {
 mysql_query("INSERT tblproducts SET productname='$productname', quatity='$quatity', unitprice='$unitprice', expirationdate='$expirationdate'")
 or die(mysql_error()); 
